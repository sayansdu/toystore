...
<div class="block">
    <ul class="nav nav-list below">
        ...
        %>
        <li><a href="/Kupon/admin/good/get?section_id=<%= sections2.get(i).getId() %>"><%= (sections2.get(i).getValue()) %></a></li>
        <% } %>
    </ul>
</div>
<div class="block">
    <ul class="nav nav-list">
        ...
        %>
        <li><a href="/Kupon/admin/good/get?category_id=<%= categories2.get(i).getId() %>"><%= (categories2.get(i).getValue()) %></a></li>
        <% } %>
    </ul>
    <br/>
</div>